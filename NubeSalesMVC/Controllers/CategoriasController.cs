...
namespace NubeSalesMVC.Models
{
    public class CategoriasController : Controller
    {
        ...
        public CategoriasController(NubeSalesMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string ordem, string filtroAtual, string filtro, int? pagina)
        {
            ...
            var estudantes = from obj in _context.Categoria select obj;
            ...
            int pageSize = 15;
            return View(await PaginatedList<Categoria>.CreateAsync(estudantes.AsNoTracking(), pagina ?? 1, pageSize));
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,IntPagar,IntReceber")] Categoria categoria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,IntPagar,IntReceber")] Categoria categoria)
        {
            if (id != categoria.Id)
            {
                return NotFound();
